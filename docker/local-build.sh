...
BUILD_ROOT=${BUILD_DIR:-${WORKSPACE}}
...
# export other vars
for var in WORKSPACE BASE_DISTRO CURRENT_PROJECT BUILD_ROOT GIT_PROXY_COMMAND CI_BUILD_ID TARGET_MACHINE GIT_EMAIL GIT_USER; do
